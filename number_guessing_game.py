...
guess(100)
### Now time for the computer to guess the number 
print ("Now Think of a number Between 1 and 30 and let let the computer guess your number")
def computer_guess (y):
    ...
    while feedback != "c":
        ...
        feedback =input(f'Is {random_number} high (H),Low (L) or Correct (C)?').lower()
        if feedback == 'h':
